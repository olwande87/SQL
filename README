...
CREATE TABLE IF NOT EXISTS address ( 
                ...
                last_update timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY (address_id),
...
FROM language WHERE name = "English" ) AND (title LIKE "K%") OR (title LIKE "Q%");
